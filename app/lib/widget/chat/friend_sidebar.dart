...
class _FriendSidebarState extends State<FriendSidebar> with Refena {
  ...
  Widget build(BuildContext context) {
    ...
    // Watched here rather than in the tab so that a drag moving across the list
    // only rebuilds the list, not the conversation.
...
class _FriendTile extends StatelessWidget {
  ...
  /// A file drag is hovering over this row: dropping now sends to this friend.
    ...
    return Opacity(
      ...
      child: DecoratedBox(
        decoration: BoxDecoration(
          ...
          border: Border.all(color: dropTarget ? theme.colorScheme.primary : Colors.transparent),
        ),
        child: ListTile(
          dense: true,
          selected: selected,
